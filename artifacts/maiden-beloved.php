...
?>
<title>Maiden Beloved - Akasha</title>
...
<style>
:root {
    --highlighted-color:#FAC2B5 ; 
    --topnav-color: #ECE7E6;
    --search-bar-precolour:#ECE7E6;
}
</style>
            ...
            <div class="content-container">
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%);">
                    <div class="splash-art">
                        <img src="../images/artifacts/Maiden-Beloved/flower.png">
                    </div>
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            <p class="banner-title">Maiden Beloved </p>
                            <div class="banner-icons">
                                <img class="rarity" src="../images/icons/4-stars.png" alt="">
                                <img class="ghostrarity" src="../images/icons/5-stars.png" alt="">
                            </div>
                            <p class="banner-description">A fragrant flower that will bloom for all eternity and never wither.
                ...
                <div class="sources" id="dark">
                    <p>Sources:</p>
                    <a href="https://genshin-impact.fandom.com/wiki/Maiden_Beloved" target="_blank">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/e/ee/Fandom_heart-logo.svg" alt="">
                        Fandom Wiki
                    </a>

                    <a href="https://library.keqingmains.com/equipment/artifacts#maiden-beloved" target="_blank">
...
$(window).on("load", function() {
    $("#maiden-beloved-button").addClass("active");
