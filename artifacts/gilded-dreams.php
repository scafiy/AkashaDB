...
?>
<title>Gilded Dreams - Akasha</title>
...
<style>
:root {
    --highlighted-color:#EFE0BF ; 
    --topnav-color: #EBEAE7
;
    --search-bar-precolour:#EBEAE7
;
}
</style>
            ...
            <div class="content-container">
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%);">
                    <div class="splash-art">
                        <img src="../images/artifacts/Gilded-Dreams/flower.png">
                    </div>
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            <p class="banner-title">Gilded Dreams
 </p>
                ...
                <div class="sources" id="dark">
                    <p>Sources:</p>
                    <a href="https://genshin-impact.fandom.com/wiki/Gilded_Dreams" target="_blank">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/e/ee/Fandom_heart-logo.svg" alt="">
                        Fandom Wiki
                    </a>

                    <a href="https://library.keqingmains.com/equipment/artifacts#gilded-dreams" target="_blank">
...
$(window).on("load", function() {
    $("#gilded-dreams-button").addClass("active");
