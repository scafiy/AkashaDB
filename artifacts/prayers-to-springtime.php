...
?>
<title>Prayers to Springtime - Akasha</title>
...
<style>
:root {
    --highlighted-color: #9ED2FF; 
    --topnav-color:#E4E9ED ;
    --search-bar-precolour:#E4E9ED;
}
</style>
            ...
            <div class="content-container">
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%);">
                    <div class="splash-art">
                        <img src="../images/artifacts/prayers-to-springtime/flower.png">
                    </div>
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            <p class="banner-title">Prayers to Springtime
 </p>
                ...
                <div class="sources" id="dark">
                    <p>Sources:</p>
                    <a href="https://genshin-impact.fandom.com/wiki/Prayers_to_Springtime" target="_blank">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/e/ee/Fandom_heart-logo.svg" alt="">
                        Fandom Wiki
                    </a>

                    <a href="https://library.keqingmains.com/equipment/artifacts#prayers-to-springtime" target="_blank">
...
$(window).on("load", function() {
    $("#prayers-to-springtime-button").addClass("active");
