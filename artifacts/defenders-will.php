...
?>
<title>Defender's Will - Akasha</title>
...
<style>
:root {
    --highlighted-color:#8D61F9 ; 
    --topnav-color:#E2DEEC ;
    --search-bar-precolour:#E2DEEC;
}
</style>
            ...
            <div class="content-container">
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%);">
                    <div class="splash-art">
                        <img src="../images/artifacts/Defenders-Will/flower.png">
                    </div>
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            <p class="banner-title">Defender's Will </p>
                            <div class="banner-icons">
                                <img class="rarity" src="../images/icons/3-stars.png" alt="">
                                <img class="ghostrarity" src="../images/icons/4-stars.png" alt="">
                            </div>
                            <p class="banner-description">An iris that was cherished by the <a href="https://genshin-impact.fandom.com/wiki/Rostam">Guardian.</a> Unfortunately, the chance never came for it to be given to whom the Guardian loved.
                ...
                <div class="sources">
                    <p>Sources:</p>
                    <a href="https://genshin-impact.fandom.com/wiki/Defender%27s_Will" target="_blank">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/e/ee/Fandom_heart-logo.svg" alt="">
                        Fandom Wiki
                    </a>

                    <a href="https://library.keqingmains.com/equipment/artifacts#defenders-will" target="_blank">
...
$(window).on("load", function() {
    $("#defenders-will-button").addClass("active");
