...
?>
<title>Gladiator's Finale - Akasha</title>
...
<style>
:root {
    --highlighted-color: #DF5B85; 
    --topnav-color:#EADEE2 ;
    --search-bar-precolour:#EADEE2;
}
</style>
            ...
            <div class="content-container">
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%);">
                    <div class="splash-art">
                        <img src="../images/artifacts/Gladiators-Finale/flower.png">
                    </div>
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            <p class="banner-title">Gladiator's Finale
 </p>
                            <div class="banner-icons">
                                <img class="rarity" src="../images/icons/4-stars.png" alt="">
                                <img class="ghostrarity" src="../images/icons/5-stars.png" alt="">
                            </div>
                            <p class="banner-description">No one knows why the legendary gladiator wore this flower on his chest. It was the brutal warrior's only weakness.
                ...
                <div class="sources">
                    <p>Sources:</p>
                    <a href="https://genshin-impact.fandom.com/wiki/Gladiator's_Finale" target="_blank">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/e/ee/Fandom_heart-logo.svg" alt="">
                        Fandom Wiki
                    </a>

                    <a href="https://library.keqingmains.com/equipment/artifacts#gladiators-finale" target="_blank">
...
$(window).on("load", function() {
    $("#gladiators-finale-button").addClass("active");
