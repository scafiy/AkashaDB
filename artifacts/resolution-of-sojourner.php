...
?>
<title>Resolution of Sojourner - Akasha</title>
...
<style>
:root {
    --highlighted-color: #5789E4; 
    --topnav-color:#DEE2EA ;
    --search-bar-precolour:#DEE2EA;
}
</style>
            ...
            <div class="content-container">
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%);">
                    <div class="splash-art">
                        <img src="../images/artifacts/Resolution-of-Sojourner/flower.png">
                    </div>
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            <p class="banner-title">Resolution of Sojourner </p>
                            <div class="banner-icons">
                                <img class="rarity" src="../images/icons/3-stars.png" alt="">
                                <img class="ghostrarity" src="../images/icons/4-stars.png" alt="">
                            </div>
                            <p class="banner-description">A small cerulean flower with somebody's ribbon pinned to the stem.
                ...
                <div class="sources">
                    <p>Sources:</p>
                    <a href="https://genshin-impact.fandom.com/wiki/Resolution_of_Sojourner" target="_blank">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/e/ee/Fandom_heart-logo.svg" alt="">
                        Fandom Wiki
                    </a>

                    <a href="https://library.keqingmains.com/equipment/artifacts#resolution-of-sojourner" target="_blank">
...
$(window).on("load", function() {
    $("#resolution-of-sojourner-button").addClass("active");
