...
?>
<title>Vermillion Hereafter - Akasha</title>
...
<style>
:root {
    --highlighted-color:#AE5DEF ; 
    --topnav-color: #E5DEEB;
    --search-bar-precolour:#E5DEEB;
}
</style>
            ...
            <div class="content-container">
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%);">
                    <div class="splash-art">
                        <img src="../images/artifacts/Vermillion-Hereafter/flower.png">
                    </div>
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            <p class="banner-title">Vermillion Hereafter </p>
                            <div class="banner-icons">
                                <img class="rarity" src="../images/icons/4-stars.png" alt="">
                                <img class="ghostrarity" src="../images/icons/5-stars.png" alt="">
                            </div>
                            <p class="banner-description">An ancient memento. It still looks as alive as the being that preserved it several centuries ago.
                ...
                <?php
                    $query = mysqli_query($conn, "SELECT * FROM `artifacts` WHERE `url` = 'vermillion-hereafter' ") or die(mysqli_error());
...
<script type="text/javascript">
$(window).on("load", function() {
    $("#vermillion-hereafter-button").addClass("active");
    $("#artifact-dropdown-icon").addClass("active-dropdown-icon");
    $("#artifact-dropdown-content").addClass("active-dropdown-content");
 });
</script>
