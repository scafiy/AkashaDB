...
<style>
:root {
    --highlighted-color: #6098E5; 
    --topnav-color:#DEE3EA ;
    --search-bar-precolour:#DEE3EA;
}
</style>
            ...
            <div class="content-container">
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%);">
                    <div class="splash-art">
                        <img src="../images/artifacts/Pale-Flame/flower.png">
                    </div>
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            <p class="banner-title">Pale Flame</p>
                            <div class="banner-icons">
                                <img class="rarity" src="../images/icons/4-stars.png" alt="">
                                <img class="ghostrarity" src="../images/icons/5-stars.png" alt="">
                            </div>
                            <p class="banner-description">A hard, blue artificial flower. Its petals shall never wither, nor shall its colors fade.
                ...
                <?php
                    $query = mysqli_query($conn, "SELECT * FROM `artifacts` WHERE `url` = 'pale-flame' ") or die(mysqli_error());
...
$(window).on("load", function() {
    $("#pale-flame-button").addClass("active");
