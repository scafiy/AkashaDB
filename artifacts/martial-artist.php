...
?>
<title>Martial Artist - Akasha</title>
...
<style>
:root {
    --highlighted-color:#BB232B ; 
    --topnav-color: #E7D9DA;
    --search-bar-precolour:#E7D9DA;
}
</style>
            ...
            <div class="content-container">
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%);">
                    <div class="splash-art">
                        <img src="../images/artifacts/Martial-Artist/flower.png">
                    </div>
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            <p class="banner-title">Martial Artist </p>
                            <div class="banner-icons">
                                <img class="rarity" src="../images/icons/3-stars.png" alt="">
                                <img class="ghostrarity" src="../images/icons/4-stars.png" alt="">
                            </div>
                            <p class="banner-description">This particular kind of red flower was the only thing that could alleviate the Martial Artist's pain.
                ...
                <div class="sources">
                    <p>Sources:</p>
                    <a href="https://genshin-impact.fandom.com/wiki/Martial_Artist" target="_blank">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/e/ee/Fandom_heart-logo.svg" alt="">
                        Fandom Wiki
                    </a>

                    <a href="https://library.keqingmains.com/equipment/artifacts#martial-artist" target="_blank">
...
$(window).on("load", function() {
    $("#martial-artist-button").addClass("active");
