...
<style>
    ...
    :root {
    --highlighted-color: #F6E3C7; 
    --topnav-color: #ECEAE8;
    --search-bar-precolour:#ECEAE8;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'prototype-archaic' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">An ancient greatsword discovered in the <a href="https://genshin-impact.fandom.com/wiki/Blackcliff_Forge">Blackcliff Forge</a>. It swings with such an immense force that one feels it could cut straight through reality itself.
