...
<style>
    ...
    :root {
    --highlighted-color: #9DD5E7; 
    --topnav-color: #E4E9EB;
    --search-bar-precolour:#E4E9EB;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'skyrider-greatsword' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A reliable steel sword. The legendary Skyrider once tried to ride it as a flying sword... for the second time.
