...
<style>
    ...
    :root {
    --highlighted-color: #B48066; 
    --topnav-color: #E6E1DF;
    --search-bar-precolour:#E6E1DF;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'predator' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A uniquely designed bow. This should not belong in this world.
