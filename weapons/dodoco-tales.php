...
<style>
    ...
    :root {
    --highlighted-color: #C64029; 
    --topnav-color: #E8DBD9;
    --search-bar-precolour:#E8DBD9;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'dodoco-tales' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A children's book filled with childish short stories at which one cannot help but laugh.
