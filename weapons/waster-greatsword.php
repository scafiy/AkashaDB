...
<style>
    ...
    :root {
    --highlighted-color: #9B8993; 
    --topnav-color: #E4E2E3;
    --search-bar-precolour:#E4E2E3;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'waster-greatsword' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A sturdy sheet of iron that may be powerful enough to break apart mountains, if wielded with enough willpower.
