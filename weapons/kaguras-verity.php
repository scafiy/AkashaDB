...
<style>
    ...
    :root {
    --highlighted-color: #EA7BFF; 
    --topnav-color: #EBE1ED;
    --search-bar-precolour:#EBE1ED;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'kaguras-verity' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">The bells used when performing the Kagura Dance, blessed by the <a href="../characters/yae.php">Guuji</a> herself. The scent of the <a href="https://genshin-impact.fandom.com/wiki/Sacred_Sakura">Sacred Sakura tree</a> lingers on it.
