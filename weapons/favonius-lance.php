...
<style>
    ...
    :root {
    --highlighted-color: #CAC2B0; 
    --topnav-color: #E8E7E6;
    --search-bar-precolour:#E8E7E6;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'favonius-lance' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A polearm made in the style of the <a href="https://genshin-impact.fandom.com/wiki/Knights_of_Favonius">Knights of Favonius</a>. Its shaft is straight, and its tip flows lightly like the wind.
