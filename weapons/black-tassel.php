...
<style>
    ...
    :root {
    --highlighted-color: #637FA0; 
    --topnav-color: #DFE1E4;
    --search-bar-precolour:#DFE1E4;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'black-tassel' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">An exceptionally powerful polearm that also offers a simple but elegant solution to the issue of the easily stained white tassel.
