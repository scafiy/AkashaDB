...
<style>
    ...
    :root {
    --highlighted-color: #9F81C4; 
    --topnav-color: #E4E1E7;
    --search-bar-precolour:#E4E1E7;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'kitain-cross-spear' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A special lance that was once used by a famed warrior who guarded the <a href="https://genshin-impact.fandom.com/wiki/Tatarigami">Tatarigami</a> on <a href="https://genshin-impact.fandom.com/wiki/Yashiori_Island">Yashiori Island</a>.
