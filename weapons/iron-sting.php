...
<style>
    ...
    :root {
    --highlighted-color: #F5EFDB; 
    --topnav-color: #ECEBEA;
    --search-bar-precolour:#ECEBEA;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'iron-sting' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">An exotic long-bladed rapier that somehow found its way into Liyue via foreign traders. It is light, agile, and sharp.
