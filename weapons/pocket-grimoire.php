...
<style>
    ...
    :root {
    --highlighted-color: #9B7E7A; 
    --topnav-color: #E4E1E1;
    --search-bar-precolour:#E4E1E1;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'pocket-grimoire' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A carefully compiled notebook featuring the essentials needed to pass a magic exam.
