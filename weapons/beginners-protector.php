...
<style>
    ...
    :root {
    --highlighted-color: #DFDCD7; 
    --topnav-color: #EAEAE9;
    --search-bar-precolour:#EAEAE9;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'beginners-protector' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A polearm as straight as a flag pole. Well suited to most combat situations, it has an imposing presence when swung.
