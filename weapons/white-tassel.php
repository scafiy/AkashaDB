...
<style>
    ...
    :root {
    --highlighted-color: #F4F1E6; 
    --topnav-color: #ECECEB;
    --search-bar-precolour:#ECECEB;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'white-tassel' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A standard-issue weapon of the <a href="https://genshin-impact.fandom.com/wiki/Millelith">Millelith</a> soldiers. It has a sturdy shaft and sharp spearhead. It's a reliable weapon.
