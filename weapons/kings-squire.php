...
<style>
    ...
    :root {
    --highlighted-color: #2AE75A; 
    --topnav-color: #E1EBE4;
    --search-bar-precolour:#E1EBE4;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'kings-squire' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">It has taken on the shape of a bow that can shoot the enemies of the forest down.
