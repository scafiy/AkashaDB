...
<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'sacrificial-fragments' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A weathered script, the text of which is no longer legible. A cursed item eroded by the <a href="https://genshin-impact.fandom.com/wiki/Istaroth">winds of time</a>.
