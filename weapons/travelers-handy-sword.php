...
<style>
    ...
    :root {
    --highlighted-color: #E84646; 
    --topnav-color: #EBE0E0;
    --search-bar-precolour:#EBE0E0;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'travelers-handy-sword' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A handy steel sword which contains scissors, a magnifying glass, tinder, and other useful items in its sheath.
