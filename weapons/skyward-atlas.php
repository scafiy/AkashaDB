...
<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'skyward-atlas' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A cloud atlas symbolizing <a href="https://genshin-impact.fandom.com/wiki/Dvalin">Dvalin</a> and his former master, the <a href="../characters/venti.php">Anemo Archon</a>. It details the winds and clouds of the northern regions and contains the powers of the sky and wind.
