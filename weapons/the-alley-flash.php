...
<style>
    ...
    :root {
    --highlighted-color: #7B7BA5; 
    --topnav-color: #E1E1E5;
    --search-bar-precolour:#E1E1E5;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'the-alley-flash' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A straight sword as black as the night. It once belonged to a thief who roamed the benighted streets.
