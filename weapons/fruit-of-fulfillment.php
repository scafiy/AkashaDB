...
<style>
    ...
    :root {
    --highlighted-color: #9DC731; 
    --topnav-color: #E4E8DA;
    --search-bar-precolour:#E4E8DA;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'fruit-of-fulfillment' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">It holds the potential to conquer any crisis.
