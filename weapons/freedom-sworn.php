...
<style>
    ...
    :root {
    --highlighted-color: #62B6F2; 
    --topnav-color: #DFE6EC;
    --search-bar-precolour:#DFE6EC;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'freedom-sworn' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A straight sword, azure as antediluvian song, and as keen as the oaths of freedom taken in the Land of Wind.
