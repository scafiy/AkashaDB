...
<style>
    ...
    :root {
    --highlighted-color: #DC84FE; 
    --topnav-color: #EAE2ED;
    --search-bar-precolour:#EAE2ED;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'thundering-pulse' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A longbow that was a gift from the Shogun. Eternal lightning crackles all around it.
