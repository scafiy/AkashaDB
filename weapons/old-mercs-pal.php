...
<style>
    ...
    :root {
    --highlighted-color: #78635C; 
    --topnav-color: #E1DFDE;
    --search-bar-precolour:#E1DFDE;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'old-mercs-pal' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A battle-tested greatsword that has seen better days and worse.
