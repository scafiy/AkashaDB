...
<style>
    ...
    :root {
    --highlighted-color: #E4E4E3; 
    --topnav-color: #EAEAEA;
    --search-bar-precolour:#EAEAEA;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'fillet-blade' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A sharp filleting knife. The blade is long, thin, and incredibly sharp.
