...
<style>
    ...
    :root {
    --highlighted-color: #CAAE92; 
    --topnav-color: #E8E5E3;
    --search-bar-precolour:#E8E5E3;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'hunters-bow' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A hunter's music consists of but two sounds: the twang of the bowstring and the whoosh of soaring arrows.
