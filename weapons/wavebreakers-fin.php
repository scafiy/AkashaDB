...
<style>
    ...
    :root {
    --highlighted-color: #82CBDF; 
    --topnav-color: #E1E8EA;
    --search-bar-precolour:#E1E8EA;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'wavebreakers-fin' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A naginata forged from luminscent material deep in the ocean depths. It was once the possession of the <a href="https://genshin-impact.fandom.com/wiki/Tengu">tengu</a> race.
