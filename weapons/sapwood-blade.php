...
<style>
    ...
    :root {
    --highlighted-color: #62D13F; 
    --topnav-color: #E1E9DE;
    --search-bar-precolour:#E1E9DE;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'sapwood-blade' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">It has taken on the shape of a blade that can cut down the foes of the forest.
