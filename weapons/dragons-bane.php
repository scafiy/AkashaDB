...
<style>
    ...
    :root {
    --highlighted-color: #BA7361; 
    --topnav-color: #E7E0DE;
    --search-bar-precolour:#E7E0DE;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'dragons-bane' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A polearm decorated with an entwining golden dragon. Light and sharp, this weapon may very well kill dragons with ease.
