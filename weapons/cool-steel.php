...
<style>
    ...
    :root {
    --highlighted-color: #999DC5; 
    --topnav-color: #E4E4E8;
    --search-bar-precolour:#E4E4E8;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'cool-steel' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A reliable steel-forged weapon that serves as a testament to the great adventures of its old master.
