...
<style>
    ...
    :root {
    --highlighted-color: #6AD1E8; 
    --topnav-color: #DFE9EB;
    --search-bar-precolour:#DFE9EB;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'mouuns-moon' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A lovely warbow made from seashells and coral. A mournful brilliance flows along its moonlight-colored arms.
