...
<style>
    ...
    :root {
    --highlighted-color: #D1AAFF; 
    --topnav-color: #E9E5ED;
    --search-bar-precolour:#E9E5ED;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'everlasting-moonglow' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A string of lovely jasper from the deep sea. It shines with a pure radiance like that of the moon, and just as ever-distant.
