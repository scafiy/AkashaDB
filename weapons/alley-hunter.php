...
<style>
    ...
    :root {
    --highlighted-color: #57D2DE; 
    --topnav-color: #DEE9EA;
    --search-bar-precolour:#DEE9EA;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'alley-hunter' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">An intricate, opulent longbow. It once belonged to a gentleman thief who was never caught.
