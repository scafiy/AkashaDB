...
<style>
    ...
    :root {
    --highlighted-color: #8CA2AB; 
    --topnav-color: #E2E4E5;
    --search-bar-precolour:#E2E4E5;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'magic-guide' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">Version 12. A reprint featuring corrections to Version 11 and brand-new additions based on recent developments.
