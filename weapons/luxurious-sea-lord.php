...
<style>
    ...
    :root {
    --highlighted-color: #718FBC; 
    --topnav-color: #E0E3E7;
    --search-bar-precolour:#E0E3E7;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'luxurious-sea-lord' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">The great king of the ocean. Having been air-dried, it makes for a fine weapon as well as emergency sustenance.
