...
<style>
    ...
    :root {
        --highlighted-color: #928A92; 
    --topnav-color: #E3E2E3;
    --search-bar-precolour:#E3E2E3;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'dark-iron-sword' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A perfectly ordinary iron sword, just slightly darker than most.
</p>
                        </div>
                    </div>
                </div>
