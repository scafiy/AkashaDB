...
<style>
    ...
    :root {
    --highlighted-color: #19C1E4; 
    --topnav-color: #D8E7EA;
    --search-bar-precolour:#D8E7EA;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'elegy-for-the-end' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A bow as lovely as any bard's lyre, its arrows pierce the heart like a lamenting sigh.
