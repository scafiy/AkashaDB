...
<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'favonius-greatsword' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A heavy ceremonial sword of the <a href="https://genshin-impact.fandom.com/wiki/Knights_of_Favonius">Knights of Favonius</a>. It channels elemental power easily and is highly destructive.
