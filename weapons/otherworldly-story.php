...
<style>
    ...
    :root {
    --highlighted-color: #C2E0DC; 
    --topnav-color: #E7EAEA;
    --search-bar-precolour:#E7EAEA;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'otherworldly-story' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A cheap fantasy novel with no value whatsoever. Any claim that it possesses the power of catalysis is also pure fantasy.
