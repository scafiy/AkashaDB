...
<style>
    ...
    :root {
    --highlighted-color: #8195B7; 
    --topnav-color: #E1E3E6;
    --search-bar-precolour:#E1E3E6;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'sharpshooters-oath' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">This superior bow once belonged to a master archer. However, it gives off a strong scent, thus making it unsuitable for hunting.
