...
<style>
    ...
    :root {
    --highlighted-color: #DFFCFE; 
    --topnav-color: #E9EEEE;
    --search-bar-precolour:#E9EEEE;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'calamity-queller' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A keenly honed weapon forged from some strange crystal. Its faint blue light seems to whisper of countless matters now past.
