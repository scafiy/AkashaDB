...
<style>
    ...
    :root {
    --highlighted-color: #55CCFE; 
    --topnav-color: #DDE8ED;
    --search-bar-precolour:#DDE8ED;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'sword-of-descension' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A sword of unique craftsmanship. It does not appear to belong to this world.
