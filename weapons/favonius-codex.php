...
<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'favonius-codex' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A secret tome that belonged to the scholars of the <a href="https://genshin-impact.fandom.com/wiki/Knights_of_Favonius">Knights of Favonius</a>. It describes the logic and power of elements and matter.
