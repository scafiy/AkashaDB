...
<style>
    ...
    :root {
    --highlighted-color: #3E70D1; 
    --topnav-color: #DBE0E9;
    --search-bar-precolour:#DBE0E9;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'snow-tombed-starsilver' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">An ancient greatsword that was stored between frescoes. Forged from Starsilver, it has the power to cleave through ice and snow.
