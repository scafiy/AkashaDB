...
<style>
    ...
    :root {
    --highlighted-color: #21ACAD; 
    --topnav-color: #D9E5E5;
    --search-bar-precolour:#D9E5E5;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'xiphos-moonlight' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">This ancient double-edged sword glimmers with moonlight. It is said that a now-silent Jinni dwells within it.
