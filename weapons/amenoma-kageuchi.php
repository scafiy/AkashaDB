...
<style>
    ...
    :root {
    --highlighted-color: #E6D5C1; 
    --topnav-color: #EBE9E7;
    --search-bar-precolour:#EBE9E7;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'amenoma-kageuchi' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A blade custom made for a famed samurai who could strike down a tengu warrior, known for their incredible agility, in midair.
