...
<style>
    ...
    :root {
    --highlighted-color: #BDAC77; 
    --topnav-color: #E9E8E4;
    --search-bar-precolour:#E9E8E4;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'memory-of-dust' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A stone dumbbell containing distant memories. Its endless transformations reveal the power within.
