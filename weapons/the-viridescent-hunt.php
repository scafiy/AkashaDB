...
<style>
    ...
    :root {
    --highlighted-color: #6ECA5B; 
    --topnav-color: #E0E8DE;
    --search-bar-precolour:#E0E8DE;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'the-viridescent-hunt' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A pure green hunting bow. This once belonged to a certain hunter whose home was the forest.
