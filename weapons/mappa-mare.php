...
<style>
    ...
    :root {
    --highlighted-color: #C8E9EF; 
    --topnav-color: #E8EBEB;
    --search-bar-precolour:#E8EBEB;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'mappa-mare' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A nautical chart featuring nearby currents and climates that somehow found its way into Liyue via foreign traders.
