...
<style>
    ...
    :root {
    --highlighted-color: #59BEDA; 
    --topnav-color: #DEE7E9;
    --search-bar-precolour:#DEE7E9;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'the-flute' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">Beneath its rusty exterior is a lavishly decorated thin blade. It swings as swiftly as the wind.
