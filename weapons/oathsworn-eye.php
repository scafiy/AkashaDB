...
<style>
    ...
    :root {
    --highlighted-color: #AE93C2; 
    --topnav-color: #E5E3E7;
    --search-bar-precolour:#E5E3E7;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'oathsworn-eye' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A national treasure of <a href="https://genshin-impact.fandom.com/wiki/Enkanomiya">Byakuyakoku</a> stored in the <a href="https://genshin-impact.fandom.com/wiki/Dainichi_Mikoshi">Dainichi Mikoshi</a>. With the coming of the Serpent God, this item was used to notarize great oaths and wishes.
