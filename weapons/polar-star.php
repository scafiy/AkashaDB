...
<style>
    ...
    :root {
    --highlighted-color: #5388FB; 
    --topnav-color: #DDE2EC;
    --search-bar-precolour:#DDE2EC;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'polar-star' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A pristine bow that is as sharp as the glaciers of the far north.
