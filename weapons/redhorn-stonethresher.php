...
<style>
    ...
    :root {
    --highlighted-color: #A90F11; 
    --topnav-color: #E5D7D7;
    --search-bar-precolour:#E5D7D7;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'redhorn-stonethresher' ") or die(mysqli_error());
        ...
        <div class="maincontent">
            <div class="content-container">
                ...
                <div class="information">
                    <div class="sources">
                        <p>Sources:</p>
                        <a href="https://genshin-impact.fandom.com/wiki/Redhorn_Stonethresher" target="_blank">
