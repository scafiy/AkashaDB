...
<style>
    ...
    :root {
    --highlighted-color: #9A95A9; 
    --topnav-color: #E4E3E5;
    --search-bar-precolour:#E4E3E5;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'debate-club' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A handy club made of fine steel. The most persuasive line of reasoning in any debater's arsenal.
