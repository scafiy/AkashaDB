...
<style>
    ...
    :root {
    --highlighted-color: #C3282E; 
    --topnav-color: #EAE4E5;
    --search-bar-precolour:#EAE4E5;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'frostbearer' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A fruit that possesses a strange, frosty will. A faint sense of agony emanates from it.
