...
<style>
    ...
    :root {
    --highlighted-color: #A86CF6; 
    --topnav-color: #E5DFEC;
    --search-bar-precolour:#E5DFEC;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'mistsplitter-reforged' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A sword that blazes with a fierce violet light. The name "Reforged" comes from it having been broken once before.
