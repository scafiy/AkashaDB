...
<style>
    ...
    :root {
    --highlighted-color: #E0BB81; 
    --topnav-color: #EAE7E1;
    --search-bar-precolour:#EAE7E1;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'solar-pearl' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A dull, golden pearl made of an unknown substance that harbors the light of the sun and the moon, and pulses with a warm strength.
