...
<style>
    ...
    :root {
    --highlighted-color: #7F778B; 
    --topnav-color: #E1E0E2;
    --search-bar-precolour:#E1E0E2;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'seasoned-hunters-bow' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A bow that has been well-polished by time and meticulously cared for by its owner. It feels almost like an extension of the archer's arm.
