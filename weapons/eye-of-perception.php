...
<style>
    ...
    :root {
    --highlighted-color: #B654E7; 
    --topnav-color: #E6DDEB;
    --search-bar-precolour:#E6DDEB;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'eye-of-perception' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A dim black glaze pearl that is said to have the power to reach the purity of one's heart.
