...
<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'skyward-blade' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">The sword of a knight that symbolizes the restored honor of <a href="https://genshin-impact.fandom.com/wiki/Dvalin">Dvalin</a>. The blessings of the <a href="../characters/venti.php">Anemo Archon</a> rest on the fuller of the blade, imbuing the sword with the powers of the sky and the wind.
