...
<style>
    ...
    :root {
    --highlighted-color: #828EFD; 
    --topnav-color: #E1E3ED;
    --search-bar-precolour:#E1E3ED;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'aqua-simulacra' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">This longbow's color is unpredictable. Under the light, it takes on a lustrous, watery blue.
