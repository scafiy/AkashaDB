...
<style>
    ...
    :root {
    --highlighted-color: #ED6556; 
    --topnav-color: #EBE2E1;
    --search-bar-precolour:#EBE2E1;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'staff-of-homa' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A "firewood staff" that was once used in ancient and long-lost rituals.
