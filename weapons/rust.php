...
<style>
    ...
    :root {
    --highlighted-color: #9F4146; 
    --topnav-color: #E4DCDC;
    --search-bar-precolour:#E4DCDC;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'rust' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A completely rusted iron greatbow. The average person would lack the strength to even lift it, let alone fire it.
