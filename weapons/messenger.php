...
<style>
    ...
    :root {
    --highlighted-color: #E37691; 
    --topnav-color: #EAE0E3;
    --search-bar-precolour:#EAE0E3;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'messenger' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A basic wooden bow. It is said to have once been used as a tool for long-distance communication.
