...
<style>
    ...
    :root {
    --highlighted-color: #7980A8; 
    --topnav-color: #E6E6E8;
    --search-bar-precolour:#E6E6E8;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'ferrous-shadow' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A replica of the famed sword of <a href="https://genshin-impact.fandom.com/wiki/Arundolyn">Arundolyn</a>, the Lion of Light. Feel the power of a legendary hero as you hold this sword in your hand! Imagine yourself as the great warrior himself! Note: Daydreaming not recommended in live combat.
