...
<style>
    ...
    :root {
    --highlighted-color: #60BB61; 
    --topnav-color: #DEE7DE;
    --search-bar-precolour:#DEE7DE;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'moonpiercer' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">It is shaped like a giant arrow and can be used as a spear.
