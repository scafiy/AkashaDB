...
<style>
    ...
    :root {
    --highlighted-color: #FF391A; 
    --topnav-color: #ECE4E2;
    --search-bar-precolour:#ECE4E2;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'kagotsurube-isshin' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">This famed blade was born in a nation to the far north. But in the name of "Isshin," it was stained with many a dark deed on its home-bound journey.
