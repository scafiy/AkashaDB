...
<style>
    ...
    :root {
    --highlighted-color: #7FE9D1; 
    --topnav-color: #E1EBE9;
    --search-bar-precolour:#E1EBE9;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'rainslasher' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A fluorescent greatsword with no sharp edge that crushes enemies with brute force and raw power.
