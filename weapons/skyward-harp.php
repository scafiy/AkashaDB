...
<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'skyward-harp' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A greatbow that symbolizes <a href="https://genshin-impact.fandom.com/wiki/Dvalin">Dvalin's</a> affiliation with the <a href="../characters/venti.php">Anemo Archon</a>. The sound of the bow firing is music to the Anemo Archon's ears. It contains the power of the sky and wind within.
