...
<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'prototype-starglitter' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A grudge discovered in the <a href="https://genshin-impact.fandom.com/wiki/Blackcliff_Forge">Blackcliff Forge</a>. The glimmers along the sharp edge are like stars in the night.
