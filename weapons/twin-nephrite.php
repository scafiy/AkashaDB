...
<style>
    ...
    :root {
    --highlighted-color: #B4E2C8; 
    --topnav-color: #E1E9E5;
    --search-bar-precolour:#E1E9E5;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'twin-nephrite' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A jade pendant formed by piecing together two jade stones.
