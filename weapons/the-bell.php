...
<style>
    ...
    :root {
    --highlighted-color: #C1BDC4; 
    --topnav-color: #E7E7E7;
    --search-bar-precolour:#E7E7E7;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'the-bell' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A heavy greatsword. A clock is embedded within it, though its internal mechanisms have long been damaged.
