...
<style>
    ...
    :root {
    --highlighted-color: #D8D7D6; 
    --topnav-color: #E9E9E9;
    --search-bar-precolour:#E9E9E9;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'dull-blade' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">Youthful dreams and the thrill of adventure. If this isn't enough, then make it up with valiance.
