...
<style>
    ...
    :root {
    --highlighted-color: #6FD08A; 
    --topnav-color: #E5EAE6
 ;
    --search-bar-precolour:#E5EAE6
 ;
    }
...
<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'hunters-path' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">This gilded bow was made using precious white branches. It has felled countless wicked beasts attempting to infiltrate the woods.
