...
<style>
    ...
    :root {
    --highlighted-color: #8A63BA; 
    --topnav-color: #E2DFE7;
    --search-bar-precolour:#E2DFE7;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'hamayumi' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A certain shrine maiden once owned this warbow. It was made with surpassing skill, and is both intricate and sturdy.
