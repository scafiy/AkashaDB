...
<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'prototype-rancour' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">An ancient longsword discovered in the <a href="https://genshin-impact.fandom.com/wiki/Blackcliff_Forge">Blackcliff Forge</a> that cuts through rocks like a hot knife through butter.
