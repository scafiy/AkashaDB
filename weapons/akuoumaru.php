...
<style>
    ...
    :root {
    --highlighted-color: #A8F2FD; 
    --topnav-color: #E5ECED;
    --search-bar-precolour:#E5ECED;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'akuoumaru' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">The beloved sword of the legendary "<a href="https://genshin-impact.fandom.com/wiki/Akuou">Akuou.</a>" The blade is huge and majestic, but is surprisingly easy to wield.
