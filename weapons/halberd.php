...
<style>
    ...
    :root {
    --highlighted-color: #8A98B2; 
    --topnav-color: #E2E3E6;
    --search-bar-precolour:#E2E3E6;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'halberd' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A polearm with an axe blade mounted on top that can deal quite a lot of damage. It's favored by the <a href="https://genshin-impact.fandom.com/wiki/Millelith">Millelith</a> officers.
