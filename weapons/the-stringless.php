...
<style>
    ...
    :root {
    --highlighted-color: #7CCBD7; 
    --topnav-color: #E1E8E9;
    --search-bar-precolour:#E1E8E9;
    }
    
</style>

<?php
    $query = mysqli_query($conn, "SELECT * FROM `weapons` WHERE `url` = 'the-stringless' ") or die(mysqli_error());
                ...
                <div class="banner" style="background-image: linear-gradient(to left, var(--highlighted-color), transparent 80%)">
                    ...
                    <div class="banner-detail-container">
                        <div class="banner-details">
                            ...
                            <p class="banner-description">A bow that once served as an extraordinary instrument. It is no longer capable of getting people up and dancing.
